...
class talentMappingFinal  extends DefaultValueBinder implements FromCollection, WithCustomValueBinder,WithHeadings,WithMapping,ShouldAutoSize
{
    protected $id;
    ...
    */
    ...
    {
       return KrsFinalModel::where('id_krs','=',$this->id)->where('jenis','=','isi')->get();
