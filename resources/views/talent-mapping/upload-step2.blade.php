    ...
    <div class='row'>
        <div class="col-lg-12">
            <div class="card card-statistics">
                <div class="card-body">
                    <form action='{{route('talent-mapping/prosesupload/step2')}}' method='post' enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class='row mb-3'>
                            ...
                            <div class='col-lg-10'>
                                ...
                                <select name='pegawai[]' id='pegawai' class='form-control select2  @error('pegawai') is-invalid @enderror'  multiple>
                                    <option value=''>Pilih Data Pegawai</option>
                                    @foreach ($headings[0][0] as $key => $item)
                                        <option value='{{$key.'^'.$item}}'> {{str_ireplace("_"," ",$item)}}</option>
                                    @endforeach
                                </select>
                                 @error('pegawai') <span class='invalid-feedback span-danger'>{{$message}}</span>  @enderror
                            </div>
                        </div>
                        <div class='row mb-3'>
                            ...
                            <div class='col-lg-10'>
                                ...
                                <select name='potensial[]' id='potensial' class='form-control select2  @error('potensial') is-invalid @enderror'  multiple>
                                    <option value=''>Pilih Data Pegawai</option>
                                    @foreach ($headings[0][0] as $key => $item)
                                       <option value='{{$key.'^'.$item}}'> {{str_ireplace("_"," ",$item)}}</option>
                                    @endforeach
                                </select>
                                 @error('potensial') <span class='invalid-feedback span-danger'>{{$message}}</span>  @enderror
                            </div>
                        </div>
                        <div class='row mb-3'>
                            ...
                            <div class='col-lg-10'>
                                ...
                                <select name='kinerja[]' id='kinerja' class='form-control select2  @error('kinerja') is-invalid @enderror'  multiple>
                                    <option value=''>Pilih Data Kinerja</option>
                                    @foreach ($headings[0][0] as $key => $item)
                                        <option value='{{$key.'^'.$item}}'> {{str_ireplace("_"," ",$item)}}</option>
                                    @endforeach
                                </select>
                                 @error('kinerja') <span class='invalid-feedback span-danger'>{{$message}}</span>  @enderror
                            </div>
                        </div>
                        <div class='row mb-3'>
                            <div class='col-lg-12'>
