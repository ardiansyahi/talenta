            ...
            <div class="card card-statistics">
                <div class="card-body">
                     ...
                     <div class="datatable-wrapper table-responsive">
                        <a href="/talent-mapping/export/{{$id}}" class='btn btn-success float-right mb-3 ml-2'>Export Excel</a>
                        <a href="/talent-mapping/upload/{{$id}}" class='btn btn-primary float-right mb-3'>Upload KRS Final</a>
                        <br>
                        <table id="datatable2" class="display compact table table-striped table-bordered"  width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" >@if($penkom=="pelaksana") Skoring Kompetensi Teknis Generik @elseif($penkom=='pengawas') Skoring Kompetensi Teknis @endif </th>
...
<script type="text/javascript">
         ...
         $('#datatable2').dataTable({
            ...
            ordering:true,
                    ...
                    columns: [
                        ...
                        {data: 'nip', name: 'nip'},
                        {data: 'nama', name: 'nama'},
                        {data: 'tgl_lahir', name: 'act'},
                        {data: 'pendidikan', name: 'act'},
                        {data: 'eselon', name: 'act'},
                        {data: 'level_jabatan', name: 'act'},
                        {data: 'provinsi', name: 'act'},
                        {data: 'satker', name: 'act'},
                        {data: 'nama_jabatan', name: 'act'},
                        {data: 'tmt_jabatan', name: 'act'},
                        {data: 'pangkat', name: 'act'},
                        {data: 'golongan', name: 'act'},
                        {data: 'cek_penkom', name: 'act'},
                        {data: 'skoring_mansoskul', name: 'act'},
                        {data: 'skoring_generik', name: 'act'},
                        {data: 'skoring_spesifik', name: 'act'},
                        {data: 'skoring_pendidikan', name: 'act'},
                        {data: 'total_rw_jabatan', name: 'act'},
                        {data: 'bobot_rw_jabatan', name: 'act'},
                        {data: 'bobot_rw_jabatan_total', name: 'act'},
                        {data: 'diklat_struktural', name: 'act'},
                        {data: 'bobot_ds', name: 'act'},
                        {data: 'diklat_teknis', name: 'act'},
                        {data: 'bobot_dt', name: 'act'},
                        {data: 'total_bobot', name: 'act'},
                        {data: 'total_bobot_persen', name: 'act'},
                        {data: 'skoring_pangkat', name: 'act'},
                        {data: 'year2', name: 'act'},
                        {data: 'year1', name: 'act'},
                        {data: 'penilaian_perilaku', name: 'act'},
                    ],
                    columnDefs: [
                        { className: 'text-center', targets: [1,3] },
                    ],
                    @if($penkom=="jpt"||$penkom=="administrator")
                        "aoColumnDefs": [{ "bVisible": false, "aTargets": [15,16] }]
                    @elseif($penkom=="pengawas")
                        "aoColumnDefs": [{ "bVisible": false, "aTargets": [16] }]
    ...
    function showGlobalModal(nip){
        ...
        $.getJSON( "{{route('ajx-getPegawaiDetail')}}", { nip: nip} )
