    ...
    <div class='row'>
        <div class="col-lg-12">
            <div class="card card-statistics">
                <div class="card-body">
                    <form action='{{route('talent-mapping/prosesupload')}}' method='post' enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class='row mb-3'>
                            ...
                            <div class='col-lg-10'>
                                ...
                                @error('fileupload') <span class='invalid-feedback span-danger'>{{$message}}</span>  @enderror
                            </div>
                        </div>
                        <div class='row mb-3'>
                            ...
                            <div class='col-lg-10'>
                                ...
                                @error('id_tikpot') <span class='invalid-feedback span-danger'>{{$message}}</span>  @enderror
                            </div>
                        </div>
