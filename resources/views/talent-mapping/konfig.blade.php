            ...
            <div class="card card-statistics">
                <div class="card-body">
                    <div class='alert alert-inverse-primary mb-3 text-dark'>
                        <i class='fa fa-info-circle'></i> Pastikan sudah mengambil data pegawai terabaru dan upload hasil penkom
                    </div>
                    <form action="{{route('talent-mapping/simpankonfig')}}" method='post'>
                        @csrf
                        <h4>Konfigurasi Data Pegawai</h4><hr>
                        <div class='row mb-3 mt-3'>
                            ...
                            <div class='col-sm-8'>
                                ...
                                <select name='jenis_penkom' id='jenis_penkom'  class='form-control'>
                                    ...
                                    <option value='jpt' {{(@$dataPenkom->kriteria =='jpt') ? 'selected':'';}}>JPT</option>
                                </select>
                            </div>
                        </div>
                        <div class='row mb-3 mt-3'>
                        ...
                        <div class='row mb-3 mt-3'>
                            ...
                            <div class='col-sm-8'>
                                <input type='number' name='bobot_rwjabatan' class='form-control' value="{{$bobot_rwjabatan}}">
                            </div>
                        </div>
                        ...
                        <div class='row mb-3 mt-3'>
                            ...
                            <div class='col-sm-8'>
                                <input type='number' name='bobot_diklat' class='form-control' value="{{$bobot_diklat}}">
                            </div>
                        </div>
                        ...
                        <div class='row mb-3 mt-3'>
                            ...
                            <div class='col-sm-8'>
                                <select name='skp2' class='form-control'>
                                    <option value="">Pilih Tahun SKP Year -2</option>
                                        @for($a=date('Y');$a >= (date('Y') -5);$a--)
                                            <option value={{$a;}} {{(@$skp2 ==$a) ? 'selected':'';}}>{{$a}}</option>
                                        @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class='row mb-3 mt-3'>
                            ...
                            <div class='col-sm-8'>
                                <select name='skp1' class='form-control'>
                                    <option value="">Pilih Tahun SKP Year -1</option>
                                        @for($a=date('Y');$a >= (date('Y') -5);$a--)
                                            <option value={{$a;}} {{(@$skp1 ==$a) ? 'selected':'';}}>{{$a}}</option>
                                        @endfor
                        ...
                        <table class='table table-bordered table-striped' width='100%'>
                            ...
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    <input type='number' class='form-control' name='isi[]'  value="{{@$valUmur;}}" id='ck_umur_value' placeholder="Masukkan batasan umur">
                                </td>
                                <td width='20%' align='center'>
                                    <div class="input-group date display-years" data-date-format="dd-mm-yyyy" data-date="{{'31-12-'.date('Y')}}">
                                        <input class="form-control" type="text" name="isi_det[]" id="ck_umur_dv" placeholder="{{'31-12-'.date('Y')}}" 
                            ...
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    <input type='number' class='form-control' name='isi[]' id='ck_umur_value'  value="{{@$valPns;}}" placeholder="Masukkan PNS (Tahun)">
                                </td>
                                <td width='20%' align='center'>
                                    <div class="input-group date display-years" data-date-format="dd-mm-yyyy" data-date="{{'31-12-'.date('Y')}}">
                                        <input class="form-control" type="text" name="isi_det[]" id="ck_pns_dv"
                                        placeholder="{{'31-12-'.date('Y')}}" value="{{(empty($dtPns)) ? '31-12-'.date('Y') :  $dtPns}}">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    ...
                                    <input type='hidden' name='isi[]' id='isi_pendidikan' value='{{@$arrPendidikan[0]}}'>
                                    <select name='ck_pendidikan_value[]' id='ck_pendidikan_value' class='form-control select2'  multiple  onchange="updateIsi('isi_pendidikan',this.value)">
                                        <option value=''>Pilih Pendidikan</option>
                                        @foreach ($getPendidikan as $key => $item)
                                            <option value='{{$item->pendidikan}}'  
                                            {{in_array($item->pendidikan,$arrPendidikan) ? 'selected':''}}> {{$item->pendidikan}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width='20%' align='center'><input type='hidden' name='isi_det[]' value=''></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    <input type='hidden' name='isi[]' id='isi_eselon' value="{{@$arrEselon[0]}}">
                                    <select name='ck_eselon_value[]' id='ck_eselon_value' class='form-control select2'  multiple  onchange="updateIsi('isi_eselon   ',this.value)">
                                        <option value=''>Pilih Eselon</option>
                                        @foreach ($getEselon as $key => $item)
                                            <option value='{{$item->eselon}}'
                                            {{in_array($item->eselon,$arrEselon) ? 'selected':''}}> {{$item->eselon}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width='20%' align='center'><input type='hidden' name='isi_det[]' value=''></td>
                            ...
                            <tr>
                                ...
                                <td width='7%' align='center'>
                                    ...
                                    <select name='param[]' id='ck_tmt_eselon_param' class='form-control'>
                                        ...
                                        <option value='>=' {{(@$pTmt_eselon=='>=') ? 'selected':''}}>Max</option>
                                        <option value='<=' {{(@$pTmt_eselon=='<=') ? 'selected':''}}>Min</option>

                                    </select>
                                </td>
                                <td width='60%' align='center'>
                                    <input type='number' class='form-control' name='isi[]'  id='ck_tmt_eselon_value' 
                                    placeholder="Masukkan batasan TMT Eselon (Tahun)" value='{{@$valTmt_eselon}}'>
                                </td>
                                <td width='20%' align='center'>
                                    <div class="input-group date display-years" data-date-format="dd-mm-yyyy" data-date="{{'31-12-'.date('Y')}}">
                                        <input class="form-control" name='isi_det[]' id='ck_tmt_eselon_dv' type="text" 
                                        placeholder="{{'31-12-'.date('Y')}}"  value="{{(empty($dtTmt_eselon)) ? '31-12-'.date('Y') :  $dtTmt_eselon}}">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr style='display:none'>
                                ...
                                <td width='60%' align='center'>
                                    <input type='hidden' name='isi[]' id='isi_pangkat' value="{{@$valPangkat[0]}}">
                                    <select name='ck_pangkat_value[]' id='ck_pangkat_value' class='form-control select2'  multiple    onchange="updateIsi('isi_pangkat',this.value)">
                                        <option value=''>Pilih Pangkat</option>
                                        @foreach ($getPangkat as $key => $item)
                                            <option value='{{$item->pangkat}}'
                                             {{in_array($item->pangkat,$arrPangkat) ? 'selected':''}}> {{$item->pangkat}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width='20%' align='center'><input type='hidden' name='isi_det[]' value=''></td>
                            ...
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    <input type='hidden' name='isi[]' id='isi_golongan' value="{{@$valGolongan[0]}}">
                                    <select name='ck_golongan_value[]' id='ck_golongan_value' class='form-control select2'  multiple onchange="updateIsi('isi_golongan',this.value)" >
                                        <option value=''>Pilih Golongan</option>
                                        @foreach ($getGolongan as $key => $item)
                                            <option value='{{$item->golongan}}'
                                             {{in_array($item->golongan,$arrGolongan) ? 'selected':''}}> {{$item->golongan}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width='20%' align='center'><input type='hidden' name='isi_det[]' value=''></td>
                            ...
                            <tr>
                                ...
                                <td width='7%' align='center'>
                                    ...
                                    <select name='param[]' id='ck_tmt_pangkat_param' class='form-control'>
                                        <option value='=' {{(@$pTmt_pangkat=='-') ? 'selected':''}}>=</option>
                                        <option value='>=' {{(@$pTmt_pangkat=='>=') ? 'selected':''}}>Max</option>
                                        <option value='<=' {{(@$pTmt_pangkat=='<=') ? 'selected':''}}>Min</option>
                                    </select>
                                </td>
                                <td width='60%' align='center'>
                                    <input type='number' class='form-control' name='isi[]' id='ck_tmt_pangkat_value'
                                     placeholder="Masukkan batasan TMT Pangkat (Tahun)" value="{{@$valTmt_pangkat}}">
                                </td>
                                <td width='20%' align='center'>
                                    <div class="input-group date display-years" data-date-format="dd-mm-yyyy" data-date="{{'31-12-'.date('Y')}}">
                                        <input class="form-control" name='isi_det[]'  id='ck_tmt_pangkat_dv' type="text" 
                                        placeholder="{{'31-12-'.date('Y')}}"  value="{{(empty($dtTmt_pangkat)) ? '31-12-'.date('Y') :  $dtTmt_pangkat}}">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    <input type='hidden' name='isi[]' id='isi_lvl_jabatan' value="{{@$arrLvJabatan[0]}}">
                                    <select name='ck_lvl_jabatan_value[]'  id='ck_lvl_jabatan_value' class='form-control select2'  multiple onchange="updateIsi('isi_lvl_jabatan',this.value)" >
                                        <option value=''>Pilih Level Jabatan</option>
                                        @foreach ($getLvlJabatan as $key => $item)
                                            <option value='{{$item->level_jabatan}}' 
                                            {{in_array($item->level_jabatan,$arrLvJabatan) ? 'selected':''}}> {{$item->level_jabatan}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width='20%' align='center'><input type='hidden' name='isi_det[]' value=''></td>
                            ...
                            <tr>
                                ...
                                <td width='7%' align='center'>
                                    ...
                                    <select name='param[]' id='ck_tmt_jabatan_param' class='form-control'>
                                        <option value='=' {{(@$pTmt_jabatan=='-') ? 'selected':''}}>=</option>
                                        <option value='>=' {{(@$pTmt_jabatan=='>=') ? 'selected':''}}>Max</option>
                                        <option value='<=' {{(@$pTmt_jabatan=='<=') ? 'selected':''}}>Min</option>
                                    </select>
                                </td>
                                <td width='60%' align='center'>
                                    <input type='number' class='form-control' name='isi[]' id='ck_tmt_jabatan_value' 
                                    placeholder="Masukkan batasan TMT Jabatan (Tahun)" value="{{@$valTmt_jabatan}}">
                                </td>
                                <td width='20%' align='center'>
                                    <div class="input-group date display-years" data-date-format="dd-mm-yyyy" data-date="{{'31-12-'.date('Y')}}">
                                        <input class="form-control" name='isi_det[]' id='ck_tmt_jabatan_dv' type="text" 
                                        placeholder="{{'31-12-'.date('Y')}}"  value="{{(empty($dtTmt_jabatan)) ? '31-12-'.date('Y') :  $dtTmt_jabatan}}">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width='20%' align='center'>
                                    <div class="input-group date display-years" data-date-format="dd-mm-yyyy" data-date="{{'31-12-'.date('Y')}}">
                                        <input class="form-control" name='isi_det[]'  id='ck_satker_dv' type="text" 
                                        placeholder="{{'31-12-'.date('Y')}}" value="{{(empty($dtSatker)) ? '31-12-'.date('Y') :  $dtSatker}}">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    <input type='hidden' name='isi[]' id='isi_tipe_pegawai' value="{{@$arrTpPegawai[0]}}">
                                    <select name='ck_tipe_pegawai_value[]'  id='ck_tipe_pegawai_value' class='form-control select2'  multiple onchange="updateIsi('isi_tipe_pegawai',this.value)" >
                                        <option value=''>Pilih Tipe Pegawai</option>
                                        @foreach ($getTipePegawai as $key => $item)
                                            <option value='{{$item->tipepegawai}}'
                                            {{in_array($item->tipepegawai,$arrTpPegawai) ? 'selected':''}}> {{$item->tipepegawai}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width='20%' align='center'><input type='hidden' name='isi_det[]' value=''></td>
                            ...
                            <tr>
                                ...
                                <td width='60%' align='center'>
                                    <input type='hidden' name='isi[]' id='isi_status_pegawai' value="{{@$arrStatPegawai[0]}}">
                                    <select name='ck_status_pegawai_value[]' id='ck_status_pegawai_value' class='form-control select2'  multiple onchange="updateIsi('isi_status_pegawai',this.value)" >
                                        <option value=''>Pilih Status Pegawai</option>
                                        @foreach ($getStatusPegawai as $key => $item)
                                            <option value='{{$item->statuspegawai}}'
                                            {{in_array($item->statuspegawai,$arrStatPegawai) ? 'selected':''}}> {{$item->statuspegawai}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td width='20%' align='center'><input type='hidden' name='isi_det[]' value=''></td>
