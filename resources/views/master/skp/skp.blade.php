    ...
    <div class='row'>
        <div class="col-lg-12">
            <div class="card card-statistics">
                <div class="card-body">
                    <form action='{{route('master/skp/cari')}}' method='POST'>
                        @csrf
                        <div class='row mb-4'>
                            ...
                            <div class='col-lg-6 mr-auto float-right'>
                                <a href='#' onclick='getSkp()' class='btn btn-dark  mr-auto float-right'>Tarik Data SKP</a>
                            </div>
                        </form>
                    </div>
         ...
         $('#datatable2').dataTable({
            ...
            serverSide: true,
                    ...
                    columns: [
                        ...
                        {data: 'pegawaiID', name: 'pegawaiID'},
                        {data: 'nip', name: 'nip'},
                        {data: 'nama', name: 'nama'},
                        {data: 'tahunPenilaian', name: 'tahunPenilaian'},
                        {data: 'tglPenilaian', name: 'tglPenilaian'},
                        {data: 'nilai_angka', name: 'nilai_angka'},
                        {data: 'rangking', name: 'rangking'},
