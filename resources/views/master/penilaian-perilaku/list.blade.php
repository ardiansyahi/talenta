    ...
    <div class='row'>
        <div class="col-lg-12">
            <div class="card card-statistics">
                <div class="card-body">
                    <form action='{{route('master/penilaian-perilaku/cari')}}' method='POST'>
                        @csrf
                        <div class='row mb-4'>
                            ...
                            <div class='col-lg-2 text-center'>
                                <input type='text' class='form-control' name='pegawai_dinilai' id='pegawai_dinilai' value='{{@$pegawai_dinilai;}}'>
                            </div>
                            <div class='col-lg-2 text-center'>
                                <input type='text' class='form-control' name='nama_dinilai' id='nama_dinilai' value='{{@$nama_dinilai;}}'>
                            </div>
                             <div class='col-lg-2 text-center'>
         ...
         $('#datatable2').dataTable({
            ...
            serverSide: true,
                    ...
                    columns: [
                        ...
                        {data: 'pegawai_dinilai', name: 'userid'},
                        {data: 'nama_dinilai', name: 'nama'},
                        {data: 'tahun', name: 'akses'},
                        {data: 'nilai_akhir', name: 'action'}
