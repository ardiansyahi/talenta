                    ...
                    <form action='{{route('master/pegawai/cari')}}' method='POST'>
                        ...
                        <div class='row mb-4'>
                            ...
                            <div class='col-lg-7 mr-auto float-right'>
                                <a href='#' onclick='getPegawai()' class='btn btn-dark  mr-auto float-right'>Tarik Data Pegawai</a>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-body" align='center'>
                        ...
                        <label id='lbl1'>Mohon Menuggu <br> Proses membutuhkan waktu yang lama, sekitar 10-25 menit</label><br>
