...
<style>
    ...
    .bgtable{
        background-color:#8e54e9;color:#fff;text-align:center;
    }
    .bgbold{
...
<script type="text/javascript">
         ...
         $('#datatable2').dataTable({
            ...
            search:false,
                    ...
                    columns: [
                        ...
                        {data: 'statuspegawai', name: 'status'},
    ...
    function showGlobalModal(nip){
        ...
        $.getJSON( "{{route('ajx-getPegawaiHistory')}}", { nip: nip} )
            ...
            $("#modal-body-detail").append(`
                ...
                $.each(result.pengawas,function(i,item){
                    ...
                    <tr >
                        ...
                        <td class="bgbold"><a href="/report/pegawai/detail-talent/pengawas/`+item.id+`/`+item.id_krs+`/`+item.nip+`" target="_BLANK">View Detail</a></td>
                    </tr>`);
                })
                ...
                $.each(result.administrator,function(i,item){
                    ...
                    <tr >
                        ...
                        <td class="bgbold">`+myArr[1]+`</td>
                        <td class="bgbold">`+myArr[2]+`</td>
                        <td class="bgbold"><a href="/report/pegawai/detail-talent/administrator/`+item.id+`/`+item.id_krs+`/`+item.nip+`" target="_BLANK">View Detail</a></td>
                    </tr>`);
                })
