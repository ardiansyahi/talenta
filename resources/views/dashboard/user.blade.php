            ...
            $.getJSON("{{ route('ajx-getPegawaiHistory') }}", {
                ...
                .done(function(result) {
                    ...
                    <table id='tbl-pengawas' class='table table-bordered table-striped' width='100%'>
                        <tr >
                            <td class="bgtable" width="20%">Tahun</td>
                            <td class="bgtable" width="20%">Potensial</td>
                            <td class="bgtable" width="20%">Kinerja</td>
                            <td class="bgtable" width="20%">Kotak</td>
                            <td class="bgtable" width="20%">View Detail</td>
                        </tr></table><br><hr>
                    <h3>Administrator</h3>
