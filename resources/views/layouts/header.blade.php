    ...
    <nav class="navbar navbar-expand-md">
        ...
        <div class="navbar-header d-flex align-items-center">
            ...
            <a class="navbar-brand" href="index.html">
                <img src="{{asset('assets/img/icon/navbar.png')}}" class="img-fluid logo-desktop" alt="logo" />
                <img src="{{asset('assets/img/icon/mnavbar.png')}}" class="img-fluid logo-mobile" alt="logo" />
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="navigation d-flex">
                ...
                <ul class="navbar-nav nav-right ml-auto" style='display:none'>
